...
public class AlienArmy {
    ...
    public void moveArmy(){
            ...
            for(int i = 9; i >= 0; i--){
                ...
                if(!rowOne[i].isHit()){
                    ...
                    if(rowOne[i].getLeftPosition() > (SpaceInvaders.WIDTH - Alien.ALIEN_WIDTH - 15)){
                        ...
                        for(int o = 0; o < 10; o++){
                            rowOne[o].setPosition(rowOne[0].getLeftPosition(), rowOne[o].getHeightPosition() + moveDistance);
                            rowTwo[0].setPosition(rowTwo[o].getLeftPosition(), rowTwo[o].getHeightPosition() + moveDistance);
                            rowThree[0].setPosition(rowThree[o].getLeftPosition(), rowThree[o].getHeightPosition() + moveDistance);
                        }
                        return;
                    }
                }
                ...
                if(!rowTwo[i].isHit()){
                    if(rowTwo[i].getLeftPosition() > (SpaceInvaders.WIDTH - Alien.ALIEN_WIDTH - 15)){
                        ...
                        for(int o = 0; o < 10; o++){
                            rowOne[o].setPosition(rowOne[0].getLeftPosition(), rowOne[o].getHeightPosition() + moveDistance);
                            rowTwo[o].setPosition(rowTwo[0].getLeftPosition(), rowTwo[o].getHeightPosition() + moveDistance);
                            rowThree[o].setPosition(rowThree[0].getLeftPosition(), rowThree[o].getHeightPosition() + moveDistance);
                        }
                        return;
                    }
                }
            ...
            for(int i = 0; i < 10; i++){
                ...
                if(rowOne[i].isHit()){
                    if(rowOne[i].getLeftPosition() < Alien.ALIEN_WIDTH){
                        ...
                        for(int o = 0; 0 < 10; i++){
                            rowOne[o].setPosition(rowOne[o].getLeftPosition(), rowOne[o].getHeightPosition() + moveDistance);
                            rowTwo[o].setPosition(rowTwo[o].getLeftPosition(), rowTwo[o].getHeightPosition() + moveDistance);
                            rowThree[o].setPosition(rowThree[o].getLeftPosition(), rowThree[o].getHeightPosition() + moveDistance);
                        }
                        return;
                    }
                }
        ...
        if(!rowOne[random1].isHit()){
            AlienShot as = new AlienShot(rowOne[random1].getLeftPosition() + (int)(Alien.ALIEN_WIDTH/2), rowOne[random1].getHeightPosition(), ship);
            alienShots.addElement(as);
        }
        if(!rowTwo[random2].isHit()){
            AlienShot as = new AlienShot(rowTwo[random2].getLeftPosition() + (int)(Alien.ALIEN_WIDTH/2), rowTwo[random2].getHeightPosition(), ship);
            alienShots.addElement(as);
        }
        if(!rowThree[random3].isHit()){
            AlienShot as = new AlienShot(rowThree[random3].getLeftPosition() + (int)(Alien.ALIEN_WIDTH/2), rowThree[random3].getHeightPosition(), ship);
            alienShots.addElement(as);
        }
    }
